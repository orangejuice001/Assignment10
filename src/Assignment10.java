...
//  Description: (Description of each file/class): This is the driver program, it contains the main menu and all the cases for the same.
                ...
                if (line.length() == 1)   //check if a user entered only one character
                {
                    switch (input1) {
                        case 'A':   //Add guest
                            ...
                            System.out.print("reservation successfully added.\n");
                            break;
                        case 'C':
                        ...
                        case 'P':
                            ...
                            if(result == -1)
                                System.out.print("Reservation not found, please try again.\n");
                            else
                        ...
                        case 'D':
                            ...
                            if(nextInLine.guests == -1)
                                System.out.print("No reservations in line currently.\n");
                            else
